...
author: "Team Name: jialinLiu, Yin Ruan, User3, User4"
date: "`r Sys.Date()`"
...
plastic_data_all_3<-plastic_data_all %>%
plastic_data_all%>% drop_na()  

mutate(pct_mismanage_plastic_ocean = (mismanaged_plastic_ocean/mismanaged_plastic)*100) %>%

  group_by(region)%>%
summarise(md_pct=median(pct_mismanage_plastic_ocean,na.rm=FALSE))
